...
#assess CI overlap
land_assoc %>%
  # Add asterisk to sig diff. Nothes that cropland/pasture was only significant with 83% CI
  mutate(NAME_STATE = if_else(
    NAME_STATE %in% c("Cropland/Pasture", "High Intensity Urban"),
    paste0(NAME_STATE, "*"),
    NAME_STATE
  )) %>%
